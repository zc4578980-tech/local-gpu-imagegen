...
checks its `0.9.0` server identity and protocol version, and requires exactly seventeen tools. This is a **Configuration contract** backed by each client's
