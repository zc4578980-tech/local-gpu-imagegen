...
`dist/local_gpu_imagegen-0.8.2-py3-none-any.whl`. Do not rebuild it during this
verification.
...
$wheel = Resolve-Path .\dist\local_gpu_imagegen-0.8.2-py3-none-any.whl
